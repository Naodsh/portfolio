        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body" style={{ lineHeight: 3 }}>
              ...
              experience in Blockchain and solidity.{" "}
            </p>
            <p
              className="home-about-body"
              style={{ lineHeight: 3, paddingTop: 30 }}
            >
              As a problem solver who loves facing challenges in my work, I'm
              excited to be at the deployment phase of my career as a web
              developer. I'm passionate and ambitious about my work, and love to
              be on a team that questions possibilities.{" "}
            </p>
            <p
              className="home-about-body"
              style={{ lineHeight: 3, paddingTop: 30 }}
            >
              ...
              I will work harder with all my ability and knowledge for the
